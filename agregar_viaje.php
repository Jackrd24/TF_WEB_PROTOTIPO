<html>
    ...
    if (isset($_REQUEST["Enviar"])) {
        $obj->registroViaje($_REQUEST["bus"], $_REQUEST["ruta"], $_REQUEST["chofer"], $_REQUEST["hora"], $_REQUEST["fecha"], $_REQUEST["costo"]);
        header("location:viajes_i.php?id=$cod&nom=$noma");
    }
    ?>
</body>
</html>
